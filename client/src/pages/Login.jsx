...
const Login = () => {
  ...
  useEffect(() => {
    ...
    if (userInfo) {
      navigate("/"); // Ensure this triggers when userInfo updates
    }
  }, [successMessage, errorMessage, userInfo]); // Include userInfo in dependencies
          ...
          <div className="grid grid-cols-2 w-[60%] mx-auto bg-white rounded-md">
            ...
            <div className="w-full h-full py-4 pr-4">
              <img
                ...
                src="https://images.pexels.com/photos/28092445/pexels-photo-28092445/free-photo-of-a-single-rose-is-sitting-on-top-of-a-broken-window.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2"
                alt=""
              />
            </div>
          </div>
