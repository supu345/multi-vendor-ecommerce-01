...
const Shipping = () => {
  ...
  return (
    <div>
      <Headers />
      <section className='bg-[url("https://images.pexels.com/photos/1482803/pexels-photo-1482803.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2")] h-[220px] mt-6 bg-cover bg-no-repeat relative bg-left'>
